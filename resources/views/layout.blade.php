...
<head>
    ...
    <title>Dashboard - Fahrul Firgiana</title>
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <a class="navbar-brand" href="index.html">
            <i class="fa-sharp fa-solid fa-city"></i> Fahrul Firgiana
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="{{ route('produk.index')}}">Data Mobil</a><a class="nav-link" href="{{ route('sopir.index')}}">Data Sopir</a><a class="nav-link" href="layout-sidenav-light.html">Data Konsumen</a></nav>
                        </div>
                        ...
                        <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                ...
                                <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                    <nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="{{ route('peminjaman.index')}}">Peminjaman</a><a class="nav-link" href="register.html">Pembayaran</a><a class="nav-link" href="password.html">Pengembalian</a></nav>
                                </div>
